...
import Users from "/src/pages/Super-Admin/Users";
import UsersArchive from "/src/pages/Super-Admin/UsersArchive";
import ReferenceData from "/src/pages/Super-Admin/ReferenceData";
import ReferenceArchive from "/src/pages/Super-Admin/ReferenceArchive";
      ...
      <div className="content-wrapper flex-grow-1">
        ...
        <div className="p-4">
          <Routes>
            ...
            <Route path="usersarchive" element={<UsersArchive />} />
            <Route path="referencedata" element={<ReferenceData />} />
            <Route path="referencearchive" element={<ReferenceArchive />} />
