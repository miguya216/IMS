...
const Users = () => {
  ...
  const confirmDelete = () => {
    ...
    fetch(`/api/User-Handlers/delete_user.php?id=${UserToDelete}`, {
      method: "POST",
    })
      .then((res) => res.json())
      .then((data) => {
  ...
  const fetchUsers = () => {
    fetch("/api/fetch_data.php?action=users")
      .then((res) => res.json())
      .then((data) => {
        setUsers(data);
        setLoading(false);
  ...
  return (
    <div className="container-fluid">
                    ...
                    <td data-label="EAF">
                      <div className="action-btn-group">
                         <button
                            ...
                            onClick={() => handlePDFPreview("EAF", user.user_ID)}
                          >
                            <img
                    ...
                    <td data-label="PAR">
                      <div className="action-btn-group">
                        <button
                          ...
                          className="action-btn"
                          onClick={() => handlePDFPreview("PAR", user.user_ID)}
                        >
                          <img
                    ...
                    <td data-label="ICS">
                      <div className="action-btn-group">
                          <button
                            ...
                            className="action-btn"
                            onClick={() => handlePDFPreview("ICS", user.user_ID)}
                          >
                            <img
                    ...
                    <td data-label="">
                      <div className="action-btn-group">
                        <button
                          title="More"
                          className="action-btn"
                          onClick={() => handleMoreClick(user.user_ID)}
                        >
                          <img
      ...
      <Popups
        ...
        confirmYesNoTitle="Delete User"
        confirmYesNoBody="Are you sure you want to archive this user?"
