...
import { generateConsumableDetailsPDF } from "/src/pages/Super-admin/forms/functions/ConsumableDetailsPDF.jsx";
...
const Consumables = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      const result = await generateConsumableDetailsPDF();
      if (result) {
        setPdfUrl(result.url);
        setPdfFilename(result.filename);
        setPdfModalOpen(true);
      } else {
        console.error("Failed to generate Consumable Details PDF");
      }
    } catch (err) {
  ...
  return (
    <div className="container-fluid">
      <TableControls
        ...
        addButtonTitle="Register Consumable"
        exportButtonTitle="Download Consumable Sticker"
        importButtonTitle="Import Consumables CSV"
