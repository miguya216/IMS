...
try {
    $sql = "
        ...
        LEFT JOIN asset_classification acl ON acl.asset_classification_ID = a.asset_classification_ID
        LEFT JOIN brand b ON b.brand_ID = a.brand_ID
        LEFT JOIN room r ON r.room_ID = pcr.room_ID
