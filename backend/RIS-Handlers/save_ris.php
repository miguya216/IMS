        ...
        foreach ($data['items'] as $item) {
            ...
            if (!empty($asset_ID)) {
                ...
                $insertRecord = $pdo->prepare("
                    ...
                    VALUES (:property_card_ID, 'RIS', :reference_ID, :officer_user_ID, :room_ID, :price_amount, :remarks)
                ");
